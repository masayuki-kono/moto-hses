...
use super::variable::{
    ByteVarHandler, DoubleVarHandler, IntegerVarHandler, PluralByteVarHandler, RealVarHandler, StringVarHandler,
};
...
impl CommandHandlerRegistry {
    ...
    pub fn new() -> Self {
        ...
        handlers.insert(0x302, Arc::new(PluralByteVarHandler) as Arc<dyn CommandHandler + Send + Sync>);
