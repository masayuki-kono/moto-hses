...
use super::variable::{
    ByteVarHandler, DoubleVarHandler, IntegerVarHandler, PluralByteVarHandler, PluralIntegerVarHandler,
    RealVarHandler, StringVarHandler,
};
...
impl CommandHandlerRegistry {
    ...
    pub fn new() -> Self {
        ...
        handlers
            .insert(0x303, Arc::new(PluralIntegerVarHandler) as Arc<dyn CommandHandler + Send + Sync>);
